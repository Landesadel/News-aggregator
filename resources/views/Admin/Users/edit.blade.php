        ...
        @endif
            <form method="post" action="{{ route('admin.users.update', ['user' => $user]) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" id="admin" name="admin" value="true" @if ($user->is_admin === true) checked @endif>
                    <label for="user">User</label>
                    <input type="radio" id="user" name="admin" value="false" @if ($user->is_admin === false) checked @endif>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" value="{{ $user->password }}" class="form-control @error('password') is-invalid @enderror">
                </div>
